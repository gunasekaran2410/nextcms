        ...
        return ( <
            ...
            Row > {
                jobs.map((list, k) => (
                    ...
                    <
                    FontAwesomeIcon className = { styles.list_icon }
                    icon = {
                        ['fas', 'briefcase'] }
                    /> <
                    h4 > { list.job_title } <
                    /h4> <
                    p className = { styles.job_content } > { list.job_description } <
                    /p> { /* <Forms/> */ } <
                    a href = "https://forms.gle/mh1D2ya6hqPbs1cv6"
                    target = "_blank" >
                    <
                    Button variant = "outline-primary"
                    className = "btns" > Apply < /Button> <
                    /a>
